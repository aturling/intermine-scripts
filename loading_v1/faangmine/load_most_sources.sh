...
########################################################
# load_most_sources.sh
#
# ALMOST there! Test all species particularly xrefs
# but leave out dbsnp and experiment/expression because
# they take forever to load and have been tested earlier.
#
